...
class AddProduct extends Component {
    ...
    this.state = {
        ...
        this.changeMakeStylehandler = this.changeMakeStylehandler.bind(this);
                                    ...
                                    <div className = "card-body">
                                        ...
                                        <div className = "form-group">
                                            ...
                                            <div className = "form-group">
                                                ...
                                                <input placeholder="Material" name="brand" className="form-control" 
                                            ...
                                            <div className = "form-group">
                                                ...
                                                <input placeholder="makeStyle" name="makeStyle" className="form-control" 
                                                    value={this.state.makeStyle} onChange={this.changeMakeStylehandler}/>
                                            </div>
                                            <div className = "form-group">
                                                <label> Color: </label>
