              ...
              <div className="nav">
                    <div className="nav-img" id='mynav-img'>
                     ...
                     <div className="nav-name">
                        <div className='nav-midde-name'><a>GIỚI THIỆU</a></div>
                        <div className='nav-midde-name'><a>BẢN QUYỀN</a></div>
                        <div className='nav-midde-name'><a>SERIE BÀI VIẾT</a></div>
                        <div className='nav-midde-name'><a>LIÊN HỆ</a></div>
                        <div className='nav-midde-name'><a>WORDPRESS HOSTING</a></div>
                      <div>
                      </div>
                          <div className="nav-right">

                            <a href='https://www.facebook.com/shine.thang/' className='nav-right-name'>
                            <FontAwesomeIcon icon={faFacebook} />
                            </a>
                            <a href='https://www.facebook.com/shine.thang/' className='nav-right-name'></a> 
