...
function ProductList() {
    const products  = [  
            {
              id: "1",
              name: `"Dưới bóng cây xanh trong khu rừng rậm, có một chú khỉ tên là Bibo, người nổi tiếng với khả năng biến hóa vai độc đáo của mình. Bibo có một trái tim ấm áp và luôn tràn đầy tình yêu thương. Một ngày nọ, khi Bibo đang lang thang qua khu rừng, anh bắt gặp một cô nàng xinh đẹp tên là Luna.
